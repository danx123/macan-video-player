...
# Worker class to run yt-dlp in a separate thread
...
class ModernVideoPlayer(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Open File and Subtitle buttons
        ...
        # Set initial value from the pre-loaded config
        ...
        # Bottom layout for all controls
    ...
    def _handle_media_status_changed(self, status):
        ...
        if status == QMediaPlayer.MediaStatus.LoadedMedia and not self.is_fullscreen:
            ...
            # Get the available screen size (including taskbar consideration)
            ...
            # Determine the scaled video size
            ...
            # Prevent the window from becoming too small (optional)
