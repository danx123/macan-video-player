...
class ModernVideoPlayer(QWidget):
    def __init__(self):
        ...
        self.current_speed_index = 1 # Dimulai dari 1.0x
    ...
    def _setup_ui(self):
        ...
        # --- Bagian Baru: Tambahkan Tombol Kecepatan ---
    ...
    # --- Bagian Baru: Fungsi untuk mengubah kecepatan putar ---
