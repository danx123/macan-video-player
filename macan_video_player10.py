...
class ModernVideoPlayer(QWidget):
    ...
    def _setup_ui(self):
        ...
        url_layout.addWidget(self.btn_show_playlist)

        time_layout = QHBoxLayout()
        time_layout.addWidget(self.position_slider)
        time_layout.addWidget(self.time_label)

        # Kelompok tombol navigasi
        nav_buttons_layout = QHBoxLayout()
        nav_buttons_layout.addWidget(self.btn_open)
        nav_buttons_layout.addWidget(self.btn_open_srt)
        nav_buttons_layout.addStretch()
        nav_buttons_layout.addWidget(self.btn_prev_playlist) # Tombol playlist baru
        nav_buttons_layout.addWidget(self.btn_skip_back)
        nav_buttons_layout.addWidget(self.btn_play_pause)
        nav_buttons_layout.addWidget(self.btn_skip_forward)
        nav_buttons_layout.addWidget(self.btn_next_playlist) # Tombol playlist baru
        nav_buttons_layout.addStretch()
        nav_buttons_layout.addWidget(self.btn_stop)

        # Kelompok tombol kontrol lainnya
        settings_buttons_layout = QHBoxLayout()
        settings_buttons_layout.addStretch()
        settings_buttons_layout.addWidget(self.btn_speed)
        settings_buttons_layout.addWidget(self.btn_audio_mode)
        settings_buttons_layout.addWidget(self.btn_mute)
        settings_buttons_layout.addWidget(self.volume_slider)
        settings_buttons_layout.addWidget(self.btn_fullscreen)
        
        container_layout = QVBoxLayout()
        container_layout.addWidget(self.title_label)
        container_layout.addLayout(url_layout)
        container_layout.addLayout(time_layout)
        container_layout.addLayout(nav_buttons_layout)
        container_layout.addLayout(settings_buttons_layout)
    ...
    def _connect_signals(self):
        ...
        self.btn_prev_playlist.clicked.connect(self._play_previous_video) # BARU
        self.btn_next_playlist.clicked.connect(self._play_next_video)     # BARU
