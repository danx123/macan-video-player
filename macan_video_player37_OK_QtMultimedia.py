...
class ModernVideoPlayer(QWidget):
    ...
    def _update_control_states(self):
        ...
        # Untuk fullscreen, visibilitas kontrol diatur oleh keyPressEvent
    ...
    def _toggle_fullscreen(self):
        ...
        if self.is_fullscreen:
            ...
            self.showNormal()
            self.controls_container.setVisible(True)
            self.unsetCursor() # Pastikan kursor kembali normal saat keluar dari fullscreen
            self._update_control_states()
    ...
    def keyPressEvent(self, event):
        ...
        if key == Qt.Key.Key_F11:
            ...
            # --- FIX: Gunakan Spasi untuk menampilkan/menyembunyikan kontrol HANYA di mode fullscreen ---
            if self.is_fullscreen:
                is_visible = self.controls_container.isVisible()
                self.controls_container.setVisible(not is_visible)
            # Di mode windowed, spasi tidak melakukan apa-apa
