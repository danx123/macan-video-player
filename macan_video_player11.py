...
class ModernVideoPlayer(QWidget):
    ...
    def _setup_ui(self):
        ...
        top_controls_layout.addWidget(self.url_input)
        ...
        # Layout utama di bagian tengah, fokus ke navigasi
        main_nav_layout = QHBoxLayout()
        main_nav_layout.addStretch() # untuk centering
        main_nav_layout.addWidget(self.btn_prev_playlist)
        main_nav_layout.addWidget(self.btn_skip_back)
        main_nav_layout.addWidget(self.btn_play_pause)
        main_nav_layout.addWidget(self.btn_skip_forward)
        main_nav_layout.addWidget(self.btn_next_playlist)
        main_nav_layout.addWidget(self.btn_stop)
        main_nav_layout.addStretch() # untuk centering
        
        # Layout bawah untuk pengaturan volume, kecepatan, fullscreen
        settings_controls_layout = QHBoxLayout()
        settings_controls_layout.addStretch(1)
        settings_controls_layout.addWidget(self.btn_speed)
        settings_controls_layout.addWidget(self.btn_audio_mode)
        settings_controls_layout.addWidget(self.btn_mute)
        settings_controls_layout.addWidget(self.volume_slider)
        settings_controls_layout.addWidget(self.btn_fullscreen)
        
        container_layout = QVBoxLayout()
        container_layout.addWidget(self.title_label)
        container_layout.addLayout(top_controls_layout)
        container_layout.addLayout(slider_time_layout)
        container_layout.addLayout(main_nav_layout)
        container_layout.addLayout(settings_controls_layout)
