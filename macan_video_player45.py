...
class ModernVideoPlayer(QWidget):
    ...
    def _setup_themes(self):
        self.themes = {
            "Dark": """
                ...
                QLabel { font-size: 12px; } QListWidget { background-color: #2c3e50; }
            """,
            "Light": """
                ...
                QLabel { font-size: 12px; } QListWidget { background-color: #ffffff; }
            """,
        }
    ...
    def _setup_ui(self):
        ...
        video_layout.addWidget(self.splash_label)
