...
from PyQt6.QtCore import QUrl, Qt, QTime, QEvent, QSize, QTimer, pyqtSignal, QObject, QRect, QMimeData
    ...
    def _load_config(self):
        ...
        try:
            ...
            if last_volume is not None:
                ...
                self.audio_output.setVolume(last_volume / 100.0)
