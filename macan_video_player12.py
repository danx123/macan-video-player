...
class ModernVideoPlayer(QWidget):
    ...
    def _setup_ui(self):
        ...
        top_controls_layout.addStretch(1) # Stretch 1
        top_controls_layout.addWidget(self.url_input, 4) # URL input diberi stretch 4 agar lebih lebar
        ...
        combined_controls_layout.addStretch() # untuk centering
        ...
        combined_controls_layout.addSpacing(20) # Spacer antara navigasi dan pengaturan
        ...
        combined_controls_layout.addWidget(self.volume_slider, 2) # Slider volume diberi stretch
